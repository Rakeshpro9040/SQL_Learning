--This is the SQL Script to run the code_examples for Lesson 18
...
END;
/
--You can check the execution of the trigger by executing the following update statement
...
--To check the execution of the code 
...
-- Run after codeunder slide 25_sa
...
-- Run the code under slide 18_sa before running this code example. 
...
REM
REM 1) Code under slide 38_sa (FIRST) and then,
REM 2) Code under slide 39_na (next)
REM 
REM **** NOTE ****
REM
...
-- Run this code example before you run code under slide 37_sa 
...
--Uncomment the code below to execute the code on slide 39_na 
/*

-- Run the code under slide 37_sa before running this code example. 
...
insert into emp_details values(999,'Himuro',3000,10,'Administration');
Select * from new_emps;
Select  * from new_depts;
*/

 --Uncomment the code below to execute the code on slide 46_sa 
/*
...
--Uncomment the code below to execute the code on slide 46_sb 
/*
