--This is the SQL Script to run the code_examples for Lesson 16
...
/
SHOW ERRORS
-- Execute the following code to create the directory reports_dir
--Substitute the path with the actual location of 'instructors.txt'
...
-- Run the code under slide 17_18_sa before running this code example. 
