--The SQL Script to run the solution for Practice 19
--Run cleanup_19.sql script from /home/oracle/labs/plpu/code_ex/cleanup_scripts directory before executing the solutions.
--Uncomment code below to run the solution for Task 1_a of Practice 19
...
--Uncomment code below to run the solution for Task 1_b of Practice 19
...
--Uncomment code below to run the solution for Task 1_c of Practice 19
...
--Uncomment code below to run the solution for Task 2_a of Practice 19
...
--Uncomment code below to run the solution for Task 2_b of Practice 19
...
--Uncomment code below to run the solution for Task 2_c of Practice 19
/*
...
--Uncomment code below to run the solution for Task 2_d of Practice 19
...
--Uncomment code below to run the solution for Task 2_e of Practice 19
...
--Uncomment code below to run the solution for Task 3_a of Practice 19
...
--Uncomment code below to run the solution for Task 3_b of Practice 19
...
--Uncomment code below to run the solution for Task 3_c of Practice 19
