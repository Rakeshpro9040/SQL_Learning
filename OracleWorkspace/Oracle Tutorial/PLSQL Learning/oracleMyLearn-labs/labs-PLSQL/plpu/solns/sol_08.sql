--The SQL Script to run the solution for Practice 17
--Run cleanup_17.sql script from /home/oracle/labs/plpu/code_ex/cleanup_scripts directory before executing the solutions.
--Uncomment code below to run the solution for Task 1_a of Practice 17
...
--Uncomment code below to run the solution for Task 1_b of Practice 17
...
--Uncomment code below to run the solution for Task 1_c of Practice 17
...
--Uncomment code below to run the solution for Task 1_d of Practice 17
...
--Uncomment code below to run the solution for Task 1_e of Practice 17
...
--Uncomment code below to run the solution for Task 1_f of Practice 17
...
--Uncomment code below to run the solution for Task 1_g of Practice 17 
...
--Uncomment code below to run the solution for Task 1_h of Practice 17    
/*
...
--Uncomment code below to run the solution for Task 1_i of Practice 17    
/*
...
--Uncomment code below to run the solution for Task 1_j of Practice 17   
...
--Uncomment code below to run the solution for Task 2_a of Practice 17   
/*
...
*/
--Uncomment code below to run the solution for Task 2_b of Practice 17
/*
...
--Uncomment code below to run the solution for Task 2_c of Practice 17
/*
