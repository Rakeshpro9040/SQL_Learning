--The SQL Script to run the solution for Practice 14
--Run cleanup_14.sql script from /home/oracle/labs/plpu/code_ex/cleanup_scripts directory before executing the solutions.
--Uncomment code below to run the solution for Task 1_a of Practice 14
...
--Uncomment code below to run the solution for Task 1_b of Practice 14
...
--Uncomment code below to run the solution for Task 1_d of Practice 14
...
--Uncomment code below to run the solution for Task 1_e of Practice 14
...
--Uncomment code below to run the solution for Task 2_a of Practice 14
/*
...
--Uncomment code below to run the solution for Task 2_b of Practice 14
...
--Uncomment code below to run the solution for Task 2_c of Practice 14
...
--Uncomment code below to run the solution for Task 2_d of Practice 14
