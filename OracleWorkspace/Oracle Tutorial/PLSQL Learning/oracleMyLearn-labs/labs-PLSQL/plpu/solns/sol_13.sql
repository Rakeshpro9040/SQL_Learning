--The SQL Script to run the solution for Practice 22
--Run cleanup_22.sql script from /home/oracle/labs/plpu/code_ex/cleanup_scripts directory before executing the solutions.
...
--Uncomment code below to run the solution for Task 1_b of Practice 22
...
--Uncomment code below to run the solution for Task 1_c of Practice 22
...
--Uncomment code below to run the solution for Task 1_d of Practice 22
...
--Uncomment code below to run the solution for Task 1_e of Practice 22
...
--Uncomment code below to run the solution for Task 2_a of Practice 22
...
--Uncomment code below to run the solution for Task 2_b of Practice 22
/*
...
--Uncomment code below to run the solution for Task 2_c of Practice 22
...
--Uncomment code below to run the solution for Task 2_d of Practice 22
...
--Uncomment code below to run the solution for Task 2_e of Practice 22
...
--Uncomment code below to run the solution for Task 2_f of Practice 22
